...
export class AndroidProjectService extends projectServiceBaseLib.PlatformProjectServiceBase implements IPlatformProjectService {
	...
	public getAppResourcesDestinationDirectoryPath(projectData: IProjectData): string {
		const appResourcesDirStructureHasMigrated = this.$androidResourcesV4MigrationService.hasMigrated(projectData.getAppResourcesDirectoryPath());
	...
	public ensureConfigurationFileInAppResources(projectData: IProjectData): void {
		...
		const appResourcesDirStructureHasMigrated = this.$androidResourcesV4MigrationService.hasMigrated(appResourcesDirectoryPath);
